    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="bg-gradient-to-r from-blue-700 to-blue-600 text-white py-12 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-blue-100">Greater Kano Business Council – Community Platform</p>
          ...
          <div className="p-8 space-y-8">
            ...
            <section>
              ...
              <p className="text-gray-600 leading-relaxed">
                By accessing or using the GKBC platform (“Service”), you agree to be bound by these Terms. 
                If you do not agree, you may not use the Service. These terms apply to all members, businesses, 
                and visitors of the Greater Kano Business Council community.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-600 leading-relaxed">
                You retain ownership of content you post. By posting, you grant GKBC a non‑exclusive, royalty‑free 
            ...
            <section>
              ...
              <p className="text-gray-600 leading-relaxed">
                To the fullest extent permitted by law, GKBC shall not be liable for any indirect, incidental, 
            ...
            <section>
              ...
              <p className="text-gray-600 leading-relaxed">
                For questions about these Terms, please contact us at <a href="mailto:support@GKBC.com" className="text-blue-600 hover:underline">support@GKBC.com</a>.
              </p>
            </section>
          </div>
